        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-baseline">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl text-muted-foreground font-light max-w-md leading-relaxed">
              Typography is the voice of your design. Use it to create hierarchy
              and guide the user's eye through the content.
            </p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-2">
              ...
              <p className="text-base text-muted-foreground leading-relaxed">
                ...
                about removing the things that distract you from the things you
                love.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-12">
            ...
            <Card className="border-border/50 shadow-sm hover:shadow-md transition-all duration-300">
              <CardHeader>
                ...
                <CardTitle className="text-2xl mt-2">Minimalist Card</CardTitle>
                <CardDescription>
